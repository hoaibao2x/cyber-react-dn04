...
// Cách 2: Sử dụng hàm định nghĩa lại tên của dispatch
...
// connect tạo ra 1 component mới bao gồm tính năng của Class component của react + redux
// mapDispatchToProps phải truyền vào vị trí tham số thứ 2 của connect (nằm sau mapStateToProps)
// nếu không có mapStateToProps thì tham số đầu tiên để là null => connect (null, mapDispatchToProps)
